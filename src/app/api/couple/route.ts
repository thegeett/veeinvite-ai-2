...
//   from InvitationOverview). Cascade FKs handle events/site_versions/rsvp_*;
//   this handler also removes the rendered HTML from the invitation-sites
//   bucket and any photos under couple-photos/<id>/.
