...
/**
 * The authenticated user's most recent couple, or null. Used by the login
 * action and the /onboarding server dispatcher (plan §34) to route
 * returning users to /welcome and new users to Step 1.
 */
